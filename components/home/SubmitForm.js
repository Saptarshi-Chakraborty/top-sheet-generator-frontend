...
import FormName from '../FormPages/FormComponents/FormName';
import FormMakautRoll from '../FormPages/FormComponents/FormMakautRoll';
import FormClassRoll from '../FormPages/FormComponents/FormClassRoll';
import FormReportTitle from '../FormPages/FormComponents/FormReportTitle';
import FormOptionalFilename from '../FormPages/FormComponents/FormOptionalFileName';
import FormSemester from '../FormPages/FormComponents/FormSemester';
...
const SubmitForm = ({ isLoading, setIsLoading }) => {
    ...
    const addToLocalStorage = (studentDetails, downloadUrl, previewUrl, pdfName, pdfId) => {
        ...
        allPdfs.push({
            ...
            ca: studentDetails.ca.toUpperCase(),
            department,
            pdfId,
            pdfName,
            previewUrl,
